...
import {FilterValuesType, todolistsActions} from "features/todolistsList/todolists/todolists.reducer"
...
export const FilterTasksButtons: FC<Props> = memo(({filter, id}) => {
    ...
    return (
        <div>
            <SuperButton variant={filter === 'all' ? "outlined" : "contained"}
                         size={"small"}
                         onClick={() => changeFilterHandler('all', id)}
                         title={'All'}/>
            <SuperButton variant={filter === 'active' ? "outlined" : "contained"}
                         size={"small"}
                         onClick={() => changeFilterHandler('active', id)}
                         title={'Active'}/>
            <SuperButton variant={filter === 'completed' ? "outlined" : "contained"}
                         color="error"
                         size={"small"}
